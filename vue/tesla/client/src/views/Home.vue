<template>
  ...
  <div class="img1" @click="log">
    <div class="box" :style="des1">
      ...
      <el-row class="button">
        <el-button type="info" class="buttonDetail b1" @click="customize"
          >定制我的 Model 3</el-button
        >
        <el-button class="buttonDetail b2" @click="customize"
          >了解 Model 3</el-button
        >
      </el-row>
    </div>
  </div>
  <div class="img2">
    <div class="box" :style="des2">
      ...
      <el-row class="button">
        <el-button type="info" class="buttonDetail b1"
          >定制我的 Model Y</el-button
        >
  ...
  <div class="img6">
    ...
    <div class="botton">
      Tesla © 2022 沪ICP备2021004806号-1 沪公网安备 31011502017892 号 营业执照
      隐私和法律 联系我们 工作机会 最新消息
    </div>
  </div>
</template>
